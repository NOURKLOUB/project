    ...
    <section>
        <div className='total-122 '>
            ...
            <div className='groubs'>
                <span><i className="bi bi-patch-check-fill"></i>Learn with experts</span> 
                <span><i className="bi bi-patch-check-fill"></i>Get certificate</span> 
                <span><i className="bi bi-patch-check-fill"></i>Get membership</span> 
            </div>
           <div className='closech'>
             <button className='moves'>get started</button>
             <a className='dispatcheing' href="https://www.youtube.com/embed/tXHviS-4ygo">
            <span className='deft'><i className="bi bi-play-fill"></i></span> 
             <h6>Watch video</h6>
             </a>
           </div>
        </div>
        <div className='deferantde'>
        <div className='pnger'>
            <img className='drop' src="/public/07.png" alt="cxc"  height={450} />
            <img className='angluer' src="/public/angular.svg" alt="anguler" />
            <img className='react' src="/public/science.svg" alt="anguler" />
            <img className='figma' src='/public/figma.svg' alt="anguler" />
            <div className="coping">
              <span className='drfter'>Our daily new students</span>
              <div className="imget">
                <img src="/public/01.jpg" alt="asx" />
                <img className='women' src="/public/02.jpg" alt="asx" />
                <img className='women' src="/public/03.jpg" alt="asx" />
                <img className='women' src="/public/04.jpg" alt="asx" />
              </div>
            </div>
